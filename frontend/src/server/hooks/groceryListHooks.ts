...
export const useCreateGroceryList = () => {
  return useMutation<GroceryList, Error, GroceryList>({ mutationFn: createGroceryList });
};

export const useUpdateGroceryList = () => {
  return useMutation<GroceryList, Error, GroceryList>({ mutationFn: updateGroceryList });
};

export const useDeleteGroceryList = () => {
  return useMutation<void, Error, string>({ mutationFn: deleteGroceryList });
};
