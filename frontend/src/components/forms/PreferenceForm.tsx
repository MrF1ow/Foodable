...
export default function PreferenceForm({ className }: PreferenceFormProps) {
  ...
  return (
    <Card
      className={`w-full h-full bg-card-background text-foreground ${className}`}
    >
      <CardHeader className="flex items-center justify-between text-center">
        ...
        <CardTitle className="text-xl">
          Personalize your Foodable experience
        </CardTitle>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="e.g., Vegetarian, Plant-Based"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
