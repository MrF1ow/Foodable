...
export const GroceryHeader = ({ additionalBackClick }: GroceryHeaderProps) => {
  ...
  return (
    <div className="flex flex-row justify-between items-center w-full">
      <div className="inline-flex items-center justify-between md:justify-start bg-primary font-bold md:rounded-[0%_0%_75%_0%] md:rounded-l-lg md:rounded-tr-lg rounded-lg px-4 py-2 h-full w-full lg:w-[40%] text-2xl md:text-3xl lg:text-4xl">
        {isUser ? (
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <div
