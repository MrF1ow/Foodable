...
export default function SettingsPage() {
  ...
  const [selectedLanguage, setSelectedLanguage] = useState(user.language || "en"); // Default to English
  ...
  return (
    <MainLayout headerComponent={<GeneralHeader title="Settings" width="25%" />}>
      <ContentLayout
        mainContent={
              ...
              <div>
                ...
                <CardContent className="flex gap-4">
                  <Button
                    ...
                    className={resolvedTheme === "light" ? "bg-green-500 text-white" : "bg-gray-200 text-black"}
                  >
                    Light Mode
                  </Button>
                  <Button
                    ...
                    className={resolvedTheme === "dark" ? "bg-blue-500 text-white" : "bg-gray-200 text-black"}
                  >
                    Dark Mode
                  </Button>
                </CardContent>
                    ...
                    <>
                      ...
                      <InputCard
                        ...
                        footer={<div className="text-right">
                          <Button onClick={handleSaveProfile} disabled={isButtonDisabled}>Save Changes</Button>
                        </div>}
                      />
